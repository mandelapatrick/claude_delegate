export const searchBrainToolDef = {
    name: "search_brain",
    description: "Search the user's second brain (PARA knowledge base) for relevant context. Uses semantic search over stored entries.",
    inputSchema: {
        type: "object",
        properties: {
            query: {
...
export const addBrainEntryToolDef = {
    ...
    description: "Add a new entry to the user's second brain. Entries are stored in the PARA structure and used as context by the delegate agent.",
    inputSchema: {
        type: "object",
        properties: {
            title: {
